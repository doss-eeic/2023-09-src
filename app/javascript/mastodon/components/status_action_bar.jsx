...
const messages = defineMessages({
  ...
  //thumbsup: { id: 'status.thumbsup' , defineMessages:'Thumbs-Up'},
...
class StatusActionBar extends ImmutablePureComponent {
  ...
  handleThumbsupClick = () => {
    ...
    if (signedIn) {
      ...
      this.props.onInteractionModal('thumbs-up', this.props.status);
    }
  };
    ...
    return (
      <div className='status__action-bar'>
        ...
        <div className='inside__status__action-bar__hidden'>
          <IconButton className='status__action-bar__button star-icon' animate active={status.get('favourited')} title={intl.formatMessage(messages.favourite)} icon='star' onClick={this.handleFavouriteClick} counter={withCounters ? status.get('favourites_count') : undefined} />
          <IconButton className='status__action-bar__button star-icon' disabled={!signedIn} active={status.get('thumbsup')} title={intl.formatMessage(messages.favourite)} icon='thumbs-up' onClick={this.handleThumbsupupClick} counter={withCounters ? status.get('favourites_count') : undefined} />
